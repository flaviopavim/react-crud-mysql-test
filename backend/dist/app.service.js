...
let AppService = class AppService {
    ...
    async editarDesenvolvedor(id, desenvolvedor) {
        const defaultConnection = (0, typeorm_1.getConnection)();
        const desenvolvedorEditado = await defaultConnection.getRepository(desevolvedores_entity_1.Desenvolvedores).update(id, desenvolvedor);
